...
urlpatterns = [
    ...
    path('undo_scam_service/<int:pk>', views.undo_scam_resource, name='undo_scam_service'),
    path('undo_help_service/<int:pk>', views.undo_help_resource, name='undo_help_service'),
    path('render_phone_auth', views.render_phone_auth_view, name='render_phone_auth'),
    path('confirm_phone_auth', views.confirm_phone_auth_view, name='confirm_phone_auth'),
